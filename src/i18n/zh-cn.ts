...
export default {
	...
	'pluto.hub.dashboard.settings-tooltip': '模块设置',
	...
	'pluto.hub.export.all-success': '所有模块导出成功，备份文件路径：',
	...
	'pluto.hub.editor.ai.generate': '智能生成',
	'pluto.hub.editor.ai.title': 'AI 生成',
	'pluto.hub.editor.ai.prompt-placeholder': '请输入要生成的模块描述',
	'pluto.hub.editor.ai.prompt-label': '提示词',
	'pluto.hub.editor.ai.fast-label': '快速生成',
	'pluto.hub.editor.ai.attachments-label': '选择附件',
	'pluto.hub.editor.ai.attachments-summary': '已选择 {count} 个附件',
	'pluto.hub.editor.ai.unavailable': 'AI 生成器不可用',
	'pluto.hub.editor.ai.empty-result': '没有生成任何文件',
	'pluto.hub.editor.ai.failure': 'AI 生成失败',
	'pluto.hub.editor.ai.success': '已生成 {count} 个文件',
